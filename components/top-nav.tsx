    ...
    <header className={`sticky top-0 z-30 border-b backdrop-blur ${wrapperClass}`}>
      <div className="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
        ...
        <nav className="hidden items-center gap-2 md:flex">
          ...
          <Link href="/pomodoro" className="rounded-md px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-800">🍅 Pomodoro</Link>
          ...
          <Link href="/challenges" className="rounded-md px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-800">Challenges</Link>
          ...
          {status === 'loading' ? (
            ...
            <details className="relative">
              ...
              <div className="absolute right-0 mt-2 w-56 rounded-lg border border-slate-200 bg-white p-2 shadow-lg dark:border-slate-700 dark:bg-slate-800">
                ...
                <Link href="/challenges" className="block rounded-md px-2 py-2 text-sm text-slate-700 hover:bg-slate-100 dark:text-slate-200 dark:hover:bg-slate-700">
                  Challenges
                </Link>
